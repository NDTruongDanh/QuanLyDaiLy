...
ADD CONSTRAINT FK_MaBaoCaoDoanhSo_CHITIET_BAOCAODOANHSO FOREIGN KEY (MaBaoCaoDoanhSo) REFERENCES BAOCAO_DOANHSO (MaBaoCaoDoanhSo) ON DELETE CASCADE;
...
ALTER TABLE BAOCAO_CONGNO  DROP CONSTRAINT FK_MaDaiLy_BAOCAO_CONGNO 

ALTER TABLE BAOCAO_CONGNO  
ADD CONSTRAINT FK_MaDaiLy_BAOCAO_CONGNO FOREIGN KEY (MaDaiLy) REFERENCES DAILY (MaDaiLy) ON DELETE CASCADE;
